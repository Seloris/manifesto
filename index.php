        ...
        <div class="main-container">
            <div class="form">
                ...
                <form class="grey1 sign-form">
                    ...
                    <div class="form-group__field">
                        <label for="name">prénom ou pseudonyme *</label>
                        <input type="text" name="name" />
                    </div>
                    <div class="form-group__field">
                    ...
                    <div class="form-group__field">
                        <label for="name">activité/situation</label>
                        <input type="text" name="name" />
                    </div>
                    <div class="form-group__field">
                    ...
                    <p class="form__apropos grey1">Ce site a été conçu graphiquement par Madeleine Lequoy, étudiante en
                        ...
                        graphisme de ce site reprend et prolonge les choix effectués pour <a target="_blank"
                            href="https://www.animaux-online.com/data/document/2/1829.800.jpg">la première mise
                            en forme de
            ...
            <div>
                ...
                <ul class="blue2">
                    ...
                    <li>– dans le cadre des projets, nous devons
                        évaluer le sens de la commande, de l’oeuvre,
                ...
                <p class="red3">En tant que créateurs, créatrices, citoyennes
                    et citoyens, nous devons oeuvrer à l’intérêt
                    ...
                    nousfaut agir avec détermination, et viser une
                    transformation aussi lucide que stimulante.</p>
                <div class="grey1">
                    <div>Contact</div>
