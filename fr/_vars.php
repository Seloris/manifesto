...
$tradSubTitle1 = 'pour une pratique soutenable <br>de la création';

$tradSubTitle2 = 'À l’initiative d’un collectif de l’École Nationale Supérieure <br>
des
Arts
...
$tradJoinSignataires = '<a href="/fr/signataires.php" class="form__header bold">Je rejoins les <br> <span id="nb-signataires" class="red1">%s</span> <br>
...
// MANIFESTE
$tradManifP1 = 'Face aux enjeux environnementaux et aux
...
$tradManifListHeader1 = 'Nous voulons contribuer :';

$tradManifList1 = ' <li>– à l’émergence d’un monde soutenable,
...
$tradManifP4 = 'Pour cela, nous devons redéfinir nos priorités,
...
qui relève du gaspillage.<br>Ces objectifs impliquent une conscience et
une action écologiques, qui participent d’une
vision holistique et solidaire du monde.';

$tradManifListHeader2 = 'Nous soulignons la responsabilité des créateurs
et créatrices dans ce grand chantier social et
environnemental :';

$tradManifList2 = ' <li>– nous sommes responsables de nos œuvres
...
$tradManifP5 = 'En tant que créateurs, créatrices, citoyennes
...
transformation aussi lucide que stimulante.';
